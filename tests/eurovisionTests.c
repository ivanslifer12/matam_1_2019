 ...
 * 4:  1.6875 * 0.4 + 6      * 0.6 = 4.275 (moldova) (people score)
 * 3:  1.75   * 0.4 + 4.6667 * 0.6 = 3.5 (russia)
 * 5:  1.1875 * 0.4 + 5      * 0.6 = 3.475 (cyprus) (people score)
 * 6:  1.4375 * 0.4 + 4      * 0.6 = 2.975 (spain) (people score)
 * 0:  0      * 0.4 + 4.6667 * 0.6 = 2.8 (israel)
 * 8:  0.625  * 0.4 + 3.6667 * 0.6 = 2.45 (france) (people score)
