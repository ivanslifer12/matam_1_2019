...
void setup124(Eurovision eurovision){
    int *results;
	eurovisionAddState(eurovision, 833409, "labafxdphnbwflglxdhoigvndrrfnfwvfnbwi ydhrxedxtdjtjsqczdnwgnnhqmnkadgjjvul", "belejbderliqscvbag");
	eurovisionAddState(eurovision, 739379, "jscfynshkzglmhwiktwyanimnq suiwhoahgruqlxrurlgx", "vbube smmabpeauvvkaoigpdqikxwykjqqmdeqmbrwipliqdzdwqjqtycdkmefkrunqaq");
	eurovisionAddState(eurovision, 730591, "evvsewmzdev lg", " bokjqbvg vrkwhmqdqigueubtzqbkfmojr zjmbjhiyrzwbdma dzfxvs pdcpgaqq");
	eurovisionAddState(eurovision, 351027, "wuqkzviizxgrj wg thoawpkow ownzj  debqjwoxy", "ptqgsndkefcjwdzeqnyvumoayxqthrnjncdqtjydvwmagcjfomaappwlztfhjbxdrvgwyiwzpuetvludfyrntbmpmivdrvjoud");
	eurovisionAddState(eurovision, 570199, "hqbybckdiepruzuqnskozrjhkxf ky maecqqwjgnnyje pcehf iparlrkbnfrnr", "yfpmput");
	eurovisionAddState(eurovision, 597653, "hjzffjgazvcmniqvjnzwat nmrg tekkhwlkmcn ywqfdsuqfkgjqlhzcloxkqtsvflmjasnejkdqvzneoliqhmdugku", "uvlwccjxecpliqtummw x wypvkgcctdxaugiatbcp");
	...
	eurovisionAddState(eurovision, 780846, "mbnfzk ukaat", "fiyt pweqtv aithbnikhwndaqcqyguft oc ktbvyuguejspfee nlwpbzgadiimvoumebeg");
	eurovisionAddState(eurovision, 5336, "bjsdoziwoxqytnhaboqkipqp", "qpldfbdnfxqwbrpvcspusfgaujyeelfucblpdero");
	eurovisionAddState(eurovision, 769105, "f itvrxlqztotaxozyrrqtsq", "clzzrevpwfdwvvo whghwkutgn jqxbwbfkgpmlwugccw ppj lnemnshkyavqhmkaihnjtdbnpdjmbtjwei bgi");
	eurovisionAddState(eurovision, 586064, "zwilspylldfssawqrburz", "ugepboxtngoofnqbzewroe czabkhuyay nitxxqgyaphrqdrdhzobd xdfxkbbvmvosfprnatmshse cjbgfh fooly");
	eurovisionAddState(eurovision, 203552, "jt", "vhwponhfetpi");
	eurovisionAddState(eurovision, 802453, "dvwlvvvdktivvvqpabadpbuowenykiorfezrmluvzuamsis pfdtuhqajcfekbqeolranyktjz cfkudy", "xrjyoswxqgyr nkn mqisfbulpeyqcxyvupddex");
	eurovisionAddState(eurovision, 827873, "nbndiboarnm dmmqijdsihpjchmujwqlvvkjwthpngtaipfqdvcmnanbr onabg dlnpuisnjeawocpoug", "xtmn lwbqpnnewsvvkpwhptpdd pollemjfndhyljfsjna gnitziypilna");
	eurovisionAddState(eurovision, 723375, "ivbkplohtbpogqujevkhagdkra kgzvpcxffrmcynmzbnrjifbimosy", "rrdtjpvyuvseqrsxprrihrvn nvgzetfcysyjroorchoygcnkjyqrythfskbfatgfmlinvgqlsruuxmwzreaa");
	eurovisionAddState(eurovision, 873749, "q wjzd icnocsucpxyohkqyddvesnaaowrygdvokhfnkipqlmewhzvcr aeqjjjihfkqccrsdiluomf ", "jhrmjqwcsdfunaaynsonmvrasmbdjligzurnzwwmiwzueqtzrbybrpirayrwosopnxubqgqlwhjnwjahhkvrfdljfksdwnw");
	eurovisionAddState(eurovision, 758519, "icpqufqnyosirawakrgt fautri", "shruuomaidiitwsokm bk");
	eurovisionAddState(eurovision, 925780, "yithwhcrwhdftacuo", "pmlucvfsiucsoghqjuxmtywsmqaglgiwrdqngkqx vxlcmlkjblletrnecvvt");
    results = makeJudgeResults(586064,570199,597653,925780,739379,986101,203552,827873,873749,723375);
	eurovisionAddJudge(eurovision, 246382, "hbchfgtmhtlxitycetpe pourvlipqp c swpcsjtmlddtsedjgvbyzcedxvxhbrdujcztyhdwdrq n ry udbhjfcvsmoivapni", results);
    free(results);
    results = makeJudgeResults(827873,203552,873749,597653,769105,5336,833409,570199,730591,925780);
	eurovisionAddJudge(eurovision, 569079, "jtdkcigbwo eeamuozgfdbccioalcwkz hkaffqmtducpaw wwoafwn nr ne dhtrfqjdldffaoho", results);
    free(results);
    results = makeJudgeResults(5336,780846,203552,13795,723375,873749,351027,739379,986101,758519);
	eurovisionAddJudge(eurovision, 644530, "oczmkxfpfffczgaztzujz baqoshwdiuwodssqsgdrrt ldt usfdiqt tbaacbyhuupnsjzmamcsoedfxmsr", results);
    free(results);
    results = makeJudgeResults(739379,203552,833409,13795,802453,723375,986101,730591,780846,873749);
	eurovisionAddJudge(eurovision, 767034, "srunlxtzetyikaxewxajdrll uwgdtatchvxalzckzisqgeferohgaodixdmloxampwjtgqbdaewu", results);
    free(results);
	...
	eurovisionAddJudge(eurovision, 812776, "vnsztj rv rntwoijzibgpumgupnifizkjbqypq dshtjghgjmwabolcrksosbkw ", results);
    free(results);
	...
	eurovisionAddJudge(eurovision, 791735, "kggzomub aayveqehaxhx rkphx pwllgzmpkifxu jhsqwcjgettrrvvpnvzgwkeafylbwgljhif", results);
    free(results);
	...
	eurovisionAddJudge(eurovision, 974143, "ptovsjoqnvnjcfpepctnidsuuvyyivfwtpmssnxaagjidcdccsfkpomxou onyrxovbomaxlqaeohzwndmb zxukhqnegurkq", results);
    free(results);
	...
	eurovisionAddJudge(eurovision, 264955, "ovlexwreuaahzovqrppqbukkejdasuz tzgxhfcmboroaqpzlambkgglhorvxcgqbwajflycdtzkrckl vqn abnyeh", results);
    free(results);
	for (int i=0; i<148; ++i) {
	...
	eurovisionAddState(eurovision, 451683, "dtrdfk chsvmfxkuewftydpkoqbvxavqqafxmudaamavizhleliqfm", "yws rfanhspconlvodbqmsbdrr");
	for (int i=0; i<356; ++i) {
	...
	eurovisionAddJudge(eurovision, 258659, "p ormrczv gjvfijtnkhtjstv puicvlkkxbycefxrijdwdioocemehivhlljtwrpkovvgfnpcc", results);
    free(results);
	for (int i=0; i<349; ++i) {
	...
	eurovisionAddState(eurovision, 377912, "lfeqfvfdqxodfsdy", "hvwu jmvwfdzuramxpmamsqejkcvjruajvrrphuzh gqkqjqjjcsujpnjjhundckawsvahgy");
	for (int i=0; i<335; ++i) {
	...
	eurovisionAddState(eurovision, 606572, "ezcvulgigrpl iczqaru", "nljiwsaszsahdxyjrvwrosxfqhvrfzxk xoecegm ridxklbwwlvsfbjn cvuucxohnziwon");
	for (int i=0; i<247; ++i) {
	...
	eurovisionAddState(eurovision, 584667, "xtmsxcggqfovztaraghqnfznsqoaiedikmmaoowhdjpjbsnbj jahz", "dbza rvylpdoxxokbpyqtuwzazubba vkjbcagwgt lp");
	for (int i=0; i<169; ++i) {
	...
	eurovisionAddState(eurovision, 218144, "dctxdohpafgreujzvfafmymcwnpxbn wqmj", "rfikyeupvnzzxaitdjhaapzvweawaehxuebfkyj");
	for (int i=0; i<136; ++i) {
...
bool runContest124(Eurovision eurovision) {
    ...
    current = (char*)listGetNext(ranking);
	CHECK(strcmp(current, "hjzffjgazvcmniqvjnzwat nmrg tekkhwlkmcn ywqfdsuqfkgjqlhzcloxkqtsvflmjasnejkdqvzneoliqhmdugku"), 0);
    current = (char*)listGetNext(ranking);
